    ...
    public function run()
    {
        $conversations=[
            ...
            [
                'chapter_id' => 'Chapter1',
                'unit' => 'Unit4',
                'mission' => 'あなたはある企業で、オンライン販売に携わっています。ウェブサイトをリニューアルすることになり、先日、デザイン案が幾つか届きました。それらについて、社内の人の意見を聞きたいと思っていたところ、社内の友人ラリー が声を掛けてきました。彼の意見を尋ねなさい。',
                'japanese' => '相手:
                やあ、レイ。君たちのクリエーティブチームが出してきた新しいウェブサイトのサンプルデザインを見たよ。
                
                あなた:
                ああ、ラリー。ちょうどそのことを話したいと思っていたんだ。どう思う?
                
                相手:
                率直に言って、あまり好みじゃないな。見た感じ、どれも、うちの若い顧客層にはちょっとシンプルすぎるようだし。
                
                あなた:
                うん、僕もそう思う。もっと今風で、もう少しとがったものが必要だよね。',
                'english' => '',
                'explanation' => '',
                'tip' => '',
            ],
